...
export const eras: ArchiveEra[] = [
  {
    ...
    palette: {
      '--bg-primary': '#E9EBEE', '--bg-secondary': '#d5d8dc', '--bg-card': '#ffffff',
      '--text-primary': '#000000', '--text-secondary': '#555555',
      '--accent': '#e73431', '--accent-light': '#ff5a57', '--accent-warm': '#e73431', '--border': '#08090d',
    },
  },
  {
    id: 'era-1',
    ...
    palette: {
      ...
      '--accent': '#0066cc', '--accent-light': '#3399ff', '--accent-warm': '#0066cc', '--border': '#dddddd',
    },
  },
  {
    id: 'era-2',
    ...
    palette: {
      '--bg-primary': '#fcfaff', '--bg-secondary': '#f0eaf8', '--bg-card': '#ffffff',
      '--text-primary': '#000000', '--text-secondary': '#555555',
      '--accent': '#6b37bf', '--accent-light': '#8b5fcf', '--accent-warm': '#6b37bf', '--border': '#6b37bf',
    },
  },
  {
    id: 'era-3',
    ...
    palette: {
      '--bg-primary': '#16161a', '--bg-secondary': '#1e1e24', '--bg-card': '#29293e',
      '--text-primary': '#ffffff', '--text-secondary': '#94a1b2',
      '--accent': '#7f5af0', '--accent-light': '#e068fd', '--accent-warm': '#e068fd', '--border': '#383a61',
    },
  },
  {
    id: 'era-4',
    ...
    palette: {
      ...
      '--text-primary': '#22293a', '--text-secondary': '#607396',
      '--accent': '#2337ff', '--accent-light': '#4d5eff', '--accent-warm': '#2337ff', '--border': '#e5e7f0',
    },
  },
  {
    id: 'era-5',
    ...
    palette: {
      '--bg-primary': '#1a1f1a', '--bg-secondary': '#232923', '--bg-card': '#2a322a',
      '--text-primary': '#e8ebe4', '--text-secondary': '#9ca89a',
      '--accent': '#7c9a5e', '--accent-light': '#a3c47d', '--accent-warm': '#c4a35a', '--border': '#3a443a',
    },
  },
];
